...
class Loci < Formula
  ...
  if Hardware.is_64_bit?
    url "https://github.com/jkawamoto/loci/releases/download/0.1.5/loci_0.1.5_darwin_amd64.zip"
    sha256 "f3537221623b812847ed9c2b5fe0b742ecf983cfd4dd380f2d4af323716828a4"
  else
    url "https://github.com/jkawamoto/loci/releases/download/0.1.5/loci_0.1.5_darwin_386.zip"
